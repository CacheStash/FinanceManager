...
const ZakatMal: React.FC<ZakatMalProps> = ({ accounts, transactions, onAddTransaction }) => {
    ...
    const calculationResult = useMemo(() => {
        ...
        // Simpelkan logika Haul untuk demo
        ...
        // Logic Haul Check Sederhana (Mengambil balance terendah dari simulasi mundur)
        // Di real app, ini butuh historical balance snapshot yang akurat.
        // Di sini kita asumsikan currentTotal adalah representasi yang cukup untuk UX demo.
        let minBalanceInHaul = currentTotalAssets; 
        
        // ... (Logic historical loop disederhanakan agar tidak terlalu panjang, fokus ke UI) ...
        ...
        <div className="flex flex-col h-full bg-background pb-20 overflow-y-auto">
            ...
            <div className="p-4 space-y-6 -mt-24 relative z-20">
                        ...
                        {(['Husband', 'Wife'] as const).map(role => (
                            <button
                                ...
                                className={`flex-1 py-2 rounded-lg text-sm font-bold flex items-center justify-center gap-2 transition-all ${
                                    selectedOwner === role 
                                    ? 'bg-white/10 text-white shadow border border-white/20' // Neutral style agar masuk semua tema
                ...
                {calculationResult.status === 'OBLIGATED' ? (
                    // KOTAK WAJIB ZAKAT - MENGGUNAKAN BLENDING AGAR HARMONIS
                    <div className="bg-surface border border-white/10 p-6 rounded-2xl shadow-lg relative overflow-hidden animate-in zoom-in-95 group">
                        ...
                        <div 
                            className="absolute inset-0 opacity-20 transition-opacity group-hover:opacity-25"
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    {/* Amount tetap Kuning Emas agar menonjol sebagai 'Uang/Emas' */}
                                ...
                                <button 
                                    ...
                                    style={{ backgroundColor: '#ca8a04' }} // Tetap kuning emas untuk CTA Bayar
                                >
                        ...
                        <div className="bg-white/5 border border-white/10 p-4 rounded-xl flex gap-3 items-start">
                             ...
                             <div>
                                 ...
                                 <p className="text-gray-400 text-xs">
                                     Meski tidak wajib zakat mal, anjuran bersedekah tetap terbuka lebar.
                                 </p>
                             </div>
                        </div>
                    </div>
